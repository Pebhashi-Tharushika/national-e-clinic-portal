    ...
    <div class="row">
      ...
      <div class="col-7" id="gs-step">
        ...
        <div id="getting-started-content">With just a few simple steps, you can unlock the convenience of our National
          E-Clinic Portal. Create an account, set up a patient profile, and access a world of seamless healthcare clinic
  ...
  <div id="grid-wrapper">
    <div class="grid text-center">
      ...
      <div class="g-col-3">
        ...
        <div class="content">high-quality healthcare services delivered by skilled professionals using state-of-the-art
      ...
      <div class="g-col-3">
        ...
        <div class="content">Our dedicated staff provides prompt medical support, home treatment guidance, and addresses
    ...
    <ul class="accordion-group" id="accordion">
      <li class="accordion-item">
        ...
        <div class="article">
          ...
          <p>The National E-Clinic Portal offers universal health coverage, accessible 24/7, 365 days a year across Sri
      ...
      <li class="accordion-item">
        ...
        <div class="article">
          ...
          <p>The portal is backed by highly experienced, SLMC-registered doctors, exclusively trained SLNC-registered
            nurses, and qualified staff. All medicines and services comply with international standards, including NMRA
