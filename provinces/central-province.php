...
<body>
    <h1 class="heading"> Clinic Details of Central Provincial General Hospital</h1>
    <!-- Conditionally add button to add new clinics -->
    <a href="add_clinic.php?province=central_province" 
  ...
  // Get the clinic details for the central province
  $province = 'central_province';
  ...
  if ($clinicDetails !== false && count($clinicDetails) > 0) {
    ...
    echo "</tr>";
      ...
      if (isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] === true) {
          echo '<td><button class="btnDelete" data-id="' . htmlspecialchars($clinic['Clinic_Id']) . '" data-province="central_province">DELETE</button></td>';
      }
