...
<body>
    <h1 class="heading"> Clinic Details of Eastern Provincial General Hospital</h1>
    <a href="add_clinic.php?province=eastern_province" 
  ...
  if ($clinicDetails !== false && count($clinicDetails) > 0) {
      ...
      echo "<tr>";
          ...
          echo "<th>Place</th>";
          echo "<th>Date</th>";
          echo "<th>Time</th>";// Conditionally add another column if the user is an admin 
      ...
      if (isset($_SESSION['isAdmin']) && $_SESSION['isAdmin'] === true) {
        echo '<td><button class="btnDelete" data-id="' . htmlspecialchars($clinic['Clinic_Id']) . '" data-province="eastern_province">DELETE</button></td>';
    }
              echo "</tr>";
      }
      echo "</table>";
